...
void CA_OpenDebug (void) {}
void CA_CloseDebug (void) {}
boolean CA_FarRead (int handle, byte *dest, long length) { return false; }
boolean CA_FarWrite (int handle, byte *source, long length) { return false; }
boolean CA_ReadFile (char *filename, memptr *ptr) { return false; }
boolean CA_LoadFile (char *filename, memptr *ptr) { return false; }
boolean CA_WriteFile (char *filename, void *ptr, long length) { return false; }

long CA_RLEWCompress (unsigned *source, long length, unsigned *dest, unsigned rlewtag) { return 0; }
